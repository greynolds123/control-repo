...
module Puppet::Parser::Functions
  newfunction(:pe_size, :type => :rvalue, :doc => <<-EOS
Returns the number of elements in a string, an array or a hash
    EOS
  ) do |arguments|

    raise(Puppet::ParseError, "pe_size(): Wrong number of arguments " +
    ...
    if item.is_a?(String)
      ...
      begin
        ...
        raise(Puppet::ParseError, 'pe_size(): Requires either ' +
      ...
      raise(Puppet::ParseError, 'pe_size(): Unknown type given')
    end
