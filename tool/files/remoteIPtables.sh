...
ssh root@$d  $cwd -A INPUT  -p tcp -s $i --dport 8082 -j ACCEPT
 ...
 ssh root@$d  $cwd -A INPUT  -p tcp -s $i --dport 8150 -j ACCEPT

 ssh root@$d  $cwd -A INPUT  -p tcp -s $i --dport 5666 -j ACCEPT
 ...
 ssh root@$d  $cwd -A FORWARD  -p tcp -s $f --dport 8150 -j ACCEPT
...
ssh root@$d  $cwd -A OUTPUT  -p tcp -s $o --dport 749 -j ACCEPT
 ...
 ssh root@$d  $cwd -A OUTPUT  -p tcp -s $o --dport 8150 -j ACCEPT
 
 ssh root@$d  $cwd -A OUTPUT  -p tcp -s $o --dport 5666 -j ACCEPT
